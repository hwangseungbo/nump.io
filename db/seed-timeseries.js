...
//  - [M1] 이상치 3건(공복혈당 152·TSH 7.1·CRP 1.1)은 2026-08 중순 시연용 —
//    의사 대시보드 '이상 검사치(최근 7일)' 카드에 잡히도록 한 것으로,
//    이후 시연 시 날짜 갱신 필요 (시간이 지나면 7일 윈도 밖으로 나가는 게 정상)
...
const LABS = [
  ...
  // [M1] 최근 이상치 3건 — 2026-08 중순 시연용 (이상 검사치 카드 7일 윈도용, 상단 주석 참고)
  ['patient3', '2026-08-16', '공복혈당', '152', '70 ~ 99', 'H'],   // 개선 추세 중 일시 반등
  ['patient5', '2026-08-15', 'TSH', '7.1', '0.4 ~ 4.0', 'H'],      // 6.8에서 소폭 상승
  ['patient4', '2026-08-16', 'CRP', '1.1', '< 0.5', 'H'],          // 호전 후 재상승
];
